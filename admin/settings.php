                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="site_about" id="site_about_inp" class="form-control" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" onclick="site_title.value = general_data.site_title, site_about.value= general_data.site_about" class="btn text-secondory shadow-none" data-bs-dismiss="modal">CANCEL</button>
