...
<head>
    <title>Bhandari Hotel - home</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body class="bg-light">
    ...
    <div class="container-fluid px-lg-4 mt-4">
        <div class="swiper swiper-conatiner">
                ...
                <form>
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-2 mb-3">
                            <label class="form-label" style="font-weight: 500px;">Childern</label>
                            <select class="form-select shadow-none">
                                <option value="1">One</option>
                                <option value="2">Two</option>
                                <option value="3">Three</option>
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            ...
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-4">
            <img src="images/features/.svg" width="40px">
                <h5 class="mt-3">Wifi</h5>
            </div>
            <div class="col-lg-12 text-center mt-5">
